...
- **FIX_HASH_ISSUE** : If you will use [alx-xlx/goindex](https://github.com/alx-xlx/goindex) as index, set it to `True`. This will fix [url trouble](https://github.com/magneto261290/magneto-python-aria/issues/37). Default is `False`
